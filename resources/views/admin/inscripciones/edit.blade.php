...
@section('content_header') 
    <h1><b>Inscripciones/Modificar inscripcion del Laboratorio</b></h1>
    <hr>
@stop
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="" id="buscar_estudiante" class="form-control select2">
                                        ...
                                        <option value="{{$estudiante->id}}"
                                            {{old('buscar_estudiante', $estudiante->id)==$inscripcion->estudiante_id?'selected':''}}
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <p id="nombres">{{ $inscripcion->estudiante->nombres }}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="">Apellidos</label>
                                            <p id="apellidos">{{ $inscripcion->estudiante->apellidos }}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="">Cédula</label>
                                            <p id="ci">{{ $inscripcion->estudiante->ci }}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <p id="fecha_nacimiento">{{ $inscripcion->estudiante->fecha_nacimiento }}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="">Teléfono</label>
                                            <p id="telefono">{{ $inscripcion->estudiante->telefono }}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="">Referencia de celular</label>
                                            <p id="ref_celular">{{ $inscripcion->estudiante->ref_celular }}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <p id="persona_emergencia">{{ $inscripcion->estudiante->persona_emergencia }}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="">Numero de emergencia</label>
                                            <p id="numero_emergencia">{{ $inscripcion->estudiante->numero_emergencia }}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="">Email</label>
                                            <p id="email">{{ $inscripcion->estudiante->usuario->email }}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <p id="direccion">{{ $inscripcion->estudiante->direccion }}</p>
                                        </div>
                                    </div> 
                                </div>
                            </div>
                            <div class="col-md-4">
                                <img src="{{ url($inscripcion->estudiante->foto) }}" id="foto_estudiante" width="80%" alt="fotografia del estudiante">
                            </div>
                        </div>
                    </div>
                                                ...
                                                <select name="periodo_id" id="" class="form-control select2" required>
                                                    ...
                                                    @foreach ($periodos as $periodo)
                                                        <option value="{{$periodo->id}}"
                                                            {{old('periodo_id', $periodo->id)==$inscripcion->periodo_id?'selected':''}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select class="form-control select2" name="sede" required>
                                                    ...
                                                    <option value="Guayaquil" {{ old('sede',$inscripcion->sede) == 'Guayaquil' ? 'selected' : '' }}>Guayaquil</option>
                                                    <option value="Milagro" {{ old('sede',$inscripcion->sede) == 'Milagro' ? 'selected' : '' }}>Milagro</option>
                                                    <option value="El triunfo" {{ old('sede',$inscripcion->sede) == 'El triunfo' ? 'selected' : '' }}>El triunfo</option>
                                                </select>
                                            </div>
                                            @error('sede')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select class="form-control select2" name="facultad" required>
                                                    ...
                                                    <option value="Facultad de Ciencias Agrarias" {{ old('facultad',$inscripcion->facultad) == 'Facultad de Ciencias Agrarias' ? 'selected' : '' }}>Facultad de Ciencias Agrarias</option>
                                                    <option value="Facultad de Economía Agrícola" {{ old('facultad',$inscripcion->facultad) == 'Facultad de Economía Agrícola' ? 'selected' : '' }}>Facultad de Economía Agrícola</option>
                                                    <option value="Facultad de Medicina Veterinaria y Zootecnia" {{ old('facultad',$inscripcion->facultad) == 'Facultad de Medicina Veterinaria y Zootecnia' ? 'selected' : '' }}>Facultad de Medicina Veterinaria y Zootecnia</option>
                                                </select>
                                            </div>
                                            @error('facultad')
                                                <small style="color: red;">{{ $message }}</small>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select class="form-control select2" name="carrera" required>
                                                    ...
                                                    <option value="Agronomía" {{ old('carrera',$inscripcion->carrera) == 'Agronomía' ? 'selected' : '' }}>Agronomía</option>
                                                    <option value="Agroindustria" {{ old('carrera',$inscripcion->carrera) == 'Agroindustria' ? 'selected' : '' }}>Agroindustria</option>
                                                    <option value="Ambiental" {{ old('carrera',$inscripcion->carrera) == 'Ambiental' ? 'selected' : '' }}>Ambiental</option>
                                                    <option value="Economía" {{ old('carrera',$inscripcion->carrera) == 'Economía' ? 'selected' : '' }}>Economía</option>
                                                    <option value="Economía Agrícola" {{ old('carrera',$inscripcion->carrera) == 'Economía Agrícola' ? 'selected' : '' }}>Economía Agrícola</option>
                                                    <option value="Medicina Veterinaria" {{ old('carrera',$inscripcion->carrera) == 'Medicina Veterinaria' ? 'selected' : '' }}>Medicina Veterinaria</option>
                                                </select>
                                            </div>
                                            @error('carrera')
                                                <small style="color: red;">{{ $message }}</small>
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select name="semestre_id" id="" class="form-control select2" required>
                                                    ...
                                                    @foreach ($semestres as $semestre)
                                                        ...
                                                        {{old('semestre_id', $semestre->id)==$inscripcion->semestre_id?'selected':''}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select class="form-control select2" name="paralelo" required>
                                                    ...
                                                    <option value="A" {{ old('paralelo',$inscripcion->paralelo) == 'A' ? 'selected' : '' }}>A</option>
                                                    <option value="B" {{ old('paralelo',$inscripcion->paralelo) == 'B' ? 'selected' : '' }}>B</option>
                                                    <option value="C" {{ old('paralelo',$inscripcion->paralelo) == 'C' ? 'selected' : '' }}>C</option>
                                                    <option value="D" {{ old('paralelo',$inscripcion->paralelo) == 'D' ? 'selected' : '' }}>D</option>
                                                    <option value="E" {{ old('paralelo',$inscripcion->paralelo) == 'E' ? 'selected' : '' }}>E</option>
                                                    <option value="F" {{ old('paralelo',$inscripcion->paralelo) == 'F' ? 'selected' : '' }}>F</option>
                                                </select>
                                            </div>
                                            @error('paralelo')
                                                <small style="color: red;">{{ $message }}</small>
                ...
                <div class="col-12">
                    ...
                    <div class="card-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @foreach ($inscripcion->estudiante->inscripciones as $inscripcion)
                                    <tr>
