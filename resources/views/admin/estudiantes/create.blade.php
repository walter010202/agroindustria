...
@section('content_header') 
    <h1><b>Estudiantes/Resgistro de un nuevo estudiante</b></h1>
    <hr>
@stop
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="date" class="form-control" name="fecha_nacimiento" id="fecha_nacimiento" value="{{ old('fecha_nacimiento') }}" placeholder="Ingrese su fecha de nacimiento..." required>
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="persona_emergencia" id="persona_emergencia" value="{{ old('persona_emergencia') }}" placeholder="Ingrese a la persona de emergencia..." required>
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="numero_emergencia" id="numero_emergencia" value="{{ old('telefono') }}" placeholder="Ingrese su telefono de emergencia..." required>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="file" id="file" class="form-control" name="foto" require>
                                    </div> 
                                    <output id="list">
                                    </output>
