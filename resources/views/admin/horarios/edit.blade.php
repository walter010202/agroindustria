                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div id="datos_docente" style="display:block">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <p id="fecha_nacimiento">{{$horario->grupoAcademico->docente->ci}}</p>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <p id="sede">{{$horario->grupoAcademico->docente->sede}}</p>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label for="">Facultad</label>
                                                                <p id="facultad">{{$horario->grupoAcademico->docente->facultad}}</p>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label for="">Carrera</label>
                                                                <p id="carrera">{{$horario->grupoAcademico->docente->carrera}}</p>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <img src="{{url($horario->grupoAcademico->docente->foto)}}" id="foto_docente" width="80%" alt="fotografia del docente">
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="" value="{{$horario->grupoAcademico->periodo->nombre}}" id="periodo_id" readonly>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="" value="{{$horario->grupoAcademico->semestre->nombre}}" id="semestre_id" readonly>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="" value="{{$horario->grupoAcademico->paralelo}}" id="paralelo" readonly>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="" value="{{$horario->grupoAcademico->materia->nombre}}" id="materia_id" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            ...
                                            min="1"
                                            required
                                            placeholder="cantidad de estudiantes" value="{{$horario->grupoAcademico->cant_estudiantes}}" readonly>
                                    </div>
                                </div> 
                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select name="dia" class="form-control" required>
                                                    ...
                                                    <option value="Miércoles" {{'Miércoles' == $horario->dia ? 'selected': ''}}> Miércoles</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" name="aula" value="{{ old('aula', $horario->aula) }}" class="form-control" placeholder="Ej: 101" required>
                                            </div>
                                        </div>
                                        @error('aula')
                                        <small style="color:red">{{$message}}</small>
