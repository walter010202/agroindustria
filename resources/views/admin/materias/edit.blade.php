...
@section('content_header') 
    <h1><b>Actualizar las Materias</b></h1>
    <hr>
@stop
                    ...
                    <form action="{{route('admin.materias.update', $materia->id)}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="nombre" value="{{ old('nombre', $materia->nombre) }}" placeholder="Escriba el nombre..." required>
                            </div>
                            @error('nombre')
