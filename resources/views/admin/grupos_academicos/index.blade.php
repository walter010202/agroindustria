...
@section('content_header')
    <h1><b>Listado de Grupos academicos academicos</b></h1>
    <hr>
@stop
        ...
        <div class="col-md-8">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title">Listados Registrados en grupos academicos</h3>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a href="{{url('/admin/grupos_academicos/'.$grupos->id.'/edit')}}" style="border-radius: 0px 0px 0px 0px" class="btn btn-success btn-sm"><i class="fas fa-pencil-alt"></i></a>
                                        <form action="{{url('/admin/grupos_academicos', $grupos->id)}}" method="post"
                                                onclick="preguntar{{$grupos->id}}(event)" id="miformulario{{$grupos->id}}">
                                            @csrf 
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger btn-sm" style="border-radius: 0px 4px 4px 0px"><i class="fas fa-trash"></i></button>
                                        </form>
                                        <script>
                                            function preguntar{{$grupos->id}}(event){
                                                ...
                                                Swal.fire({
                                                    ...
                                                    if (result.isConfirmed){
                                                        var form=$('#miformulario{{$grupos->id}}');
                                                        form.submit();
