            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{url('/admin/roles/create')}}" class="btn btn-primary">Crear Rol</a>
                    </div>
                    <!--/.card-tools -->
                </div>
                <!--/.card-header--> 
                            ...
                            <tr>
                                ...
                                <td style="text-align: center">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a href="{{ route('admin.roles.permisos', $rol->id) }}" style="border-radius: 0px 0px 0px 0px" class="btn btn-warning btn-sm"><i class="fas fa-check"> Permisos</i></a>
                                        <a href="{{url('/admin/roles/'.$rol->id.'/edit')}}" style="border-radius: 0px 0px 0px 0px" class="btn btn-success btn-sm"><i class="fas fa-pencil-alt"> Editar</i></a>
