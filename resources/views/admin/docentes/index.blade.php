...
@section('content_header')
    <h1><b>Listado de Docentes/Verificación de datos registrados</b></h1>
    <hr>
@stop
            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{url('/admin/docentes/create')}}" class="btn btn-primary">Registrarse</a>
                    </div>
                    <!--/.card-tools -->
                </div>
                <!--/.card-header--> 
                            ...
                            <tr>
                                ...
                                <td style="text-align: center">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a href="{{url('/admin/docentes/'.$docente->id.'/edit')}}" style="border-radius: 0px 0px 0px 0px" class="btn btn-success btn-sm"><i class="fas fa-pencil-alt"> Editar</i></a>
